const id = "dekabr/daily_14-12.md";
						...
						const data = {title:"14 декабря.  Наркомания, наркотики, выздоровление",description:"Ежедневные размышления АН - 14 декабря.  Наркомания, наркотики, выздоровление",id:"349",moth:"dekabr"};
						const _internal = {
							type: 'content',
							filePath: "/Users/samgold/Desktop/Проекты/12 проектов/daily-na/src/content/diaries/dekabr/daily_14-12.md",
							rawData: undefined,
						};
