const id = "mart/daily_08-03.md";
						...
						const data = {title:"8 марта. Учиться любить себя",description:"Ежедневные размышления АН - 8 марта. Учиться любить себя",id:"68",moth:"mart"};
						const _internal = {
							type: 'content',
							filePath: "/Users/samgold/Desktop/Проекты/12 проектов/daily-na/src/content/diaries/mart/daily_08-03.md",
							rawData: undefined,
						};
