const id = "avgust/daily_03-08.md";
						const collection = "diaries";
						const slug = "avgust/daily_03-08";
						...
						const data = {title:"3 августа. Доверяя людям",description:"Ежедневные размышления АН - 3 августа. Доверяя людям",id:"216",moth:"avgust"};
						const _internal = {
							type: 'content',
							filePath: "/Users/samgold/Desktop/Проекты/12 проектов/daily-na/src/content/diaries/avgust/daily_03-08.md",
							rawData: undefined,
						};
