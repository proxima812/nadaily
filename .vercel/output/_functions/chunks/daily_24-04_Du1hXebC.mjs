const id = "april/daily_24-04.md";
						...
						const data = {title:"24 апреля. Двенадцать шагов жизни",description:"Ежедневные размышления АН - 24 апреля. Двенадцать шагов жизни",id:"115",moth:"april"};
						const _internal = {
							type: 'content',
							filePath: "/Users/samgold/Desktop/Проекты/12 проектов/daily-na/src/content/diaries/april/daily_24-04.md",
							rawData: undefined,
						};
