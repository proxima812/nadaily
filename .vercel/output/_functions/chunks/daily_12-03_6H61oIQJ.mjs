const id = "mart/daily_12-03.md";
						...
						const data = {title:"12 марта. Вырываясь из рутины",description:"Ежедневные размышления АН - 12 марта. Вырываясь из рутины",id:"72",moth:"mart"};
						const _internal = {
							type: 'content',
							filePath: "/Users/samgold/Desktop/Проекты/12 проектов/daily-na/src/content/diaries/mart/daily_12-03.md",
							rawData: undefined,
						};
