const id = "avgust/daily_13-08.md";
						...
						const data = {title:"13 августа.  Трудные люди",description:"Ежедневные размышления АН - 13 августа.  Трудные люди",id:"226",moth:"avgust"};
						const _internal = {
							type: 'content',
							filePath: "/Users/samgold/Desktop/Проекты/12 проектов/daily-na/src/content/diaries/avgust/daily_13-08.md",
							rawData: undefined,
						};
