const id = "oktyabr/daily_29-10.md";
						...
						const data = {title:"29 октября.   Жить сейчас",description:"Ежедневные размышления АН - 29 октября.   Жить сейчас",id:"303",moth:"oktyabr"};
						const _internal = {
							type: 'content',
							filePath: "/Users/samgold/Desktop/Проекты/12 проектов/daily-na/src/content/diaries/oktyabr/daily_29-10.md",
							rawData: undefined,
						};
