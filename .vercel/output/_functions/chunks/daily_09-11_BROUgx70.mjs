const id = "noyabr/daily_09-11.md";
						...
						const data = {title:"9 ноября.  Идеальные  планы",description:"Ежедневные размышления АН - 9 ноября.  Идеальные  планы",id:"314",moth:"noyabr"};
						const _internal = {
							type: 'content',
							filePath: "/Users/samgold/Desktop/Проекты/12 проектов/daily-na/src/content/diaries/noyabr/daily_09-11.md",
							rawData: undefined,
						};
