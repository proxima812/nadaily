const id = "maj/daily_09-05.md";
						...
						const data = {title:"9 мая. Напишите об этом!",description:"Ежедневные размышления АН - 9 мая. Напишите об этом!",id:"130",moth:"maj"};
						const _internal = {
							type: 'content',
							filePath: "/Users/samgold/Desktop/Проекты/12 проектов/daily-na/src/content/diaries/maj/daily_09-05.md",
							rawData: undefined,
						};
