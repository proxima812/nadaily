const id = "maj/daily_05-05.md";
						...
						const data = {title:"5 мая. На  все",description:"Ежедневные размышления АН - 5 мая. На  все",id:"126",moth:"maj"};
						const _internal = {
							type: 'content',
							filePath: "/Users/samgold/Desktop/Проекты/12 проектов/daily-na/src/content/diaries/maj/daily_05-05.md",
							rawData: undefined,
						};
