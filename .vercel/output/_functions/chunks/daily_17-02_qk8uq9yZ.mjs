const id = "fevral/daily_17-02.md";
						...
						const data = {title:"17 февраля. Доносить весть, а не наркомана",description:"Ежедневные размышления АН - 17 февраля. Доносить весть, а не наркомана",id:"48",moth:"fevral"};
						const _internal = {
							type: 'content',
							filePath: "/Users/samgold/Desktop/Проекты/12 проектов/daily-na/src/content/diaries/fevral/daily_17-02.md",
							rawData: undefined,
						};
