const id = "oktyabr/daily_01-10.md";
						...
						const data = {title:"1 октября.  Не просто толчок к  росту",description:"Ежедневные размышления АН - 1 октября.  Не просто толчок к  росту",id:"275",moth:"oktyabr"};
						const _internal = {
							type: 'content',
							filePath: "/Users/samgold/Desktop/Проекты/12 проектов/daily-na/src/content/diaries/oktyabr/daily_01-10.md",
							rawData: undefined,
						};
